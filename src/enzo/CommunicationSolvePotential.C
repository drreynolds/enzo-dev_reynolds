/***********************************************************************
/
/  COMMUNICATION SOLVE POTENTIAL (CALLED BY PrepareDensityField)
/
/  written by: Daniel R. Reynolds
/  date:       July 2014
/
/  contents originally part of PrepareDensityField.C,
...
/
/ ======================================================================= 
/ This routine contains the majority of what used to be in the 
/ PrepareDensityField routine.  That routine previously prepared the 
/ density field for all the grids on this level, both particle and 
/ baryonic densities, and then solved for the potential field if this is
/ level 0.  
/
/ The routine has now been broken into separate parts:
/ PrepareDensityField still prepares the density field for performing the
/ solve for the gravitational potential; this routine performs the 
/ previous FFT-based potential solve.
/
************************************************************************/
