...
/        field, and scaled by the current number density of HI, to be 
/        later unpacked by rescaling back with HI.  This potentially 
/        loses accuracy in the case that during chemistry subcycling 
/        the HI, HeI and HeII values change significantly, since we 
/        retain the initial rate scaling but use updated HI values in 
/        chemistry subcycles.
/
************************************************************************/
#ifdef TRANSFER
